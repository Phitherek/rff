...
Version 0.2.6 introduces output directory creation and copying files excluded from one conversion to output directory in handlers, so there are always all needed files in output directory.
