...
* version 0.2.7 - There is one more possible "faulty" time that prevents rff from counting percentage - "N/A". Bug fixed.
...
Version 0.2.7 fixes a bug when the returned status time is "N/A".
